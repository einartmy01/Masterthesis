...
VBOX_BAUD        = 115200
DISCIPLINE_HZ    = 10.0    # how often to compute and apply correction
    ...
    def _run(self):
        ...
        while not self._stop.is_set():
            ...
            while True:
                ...
                gap_ms  = (mono_ns - self._last_mono_ns) / 1_000_000 if self._last_mono_ns else 0
                if gap_ms > 30:
                    print(f"  [vbox] WARNING large frame gap: {gap_ms:.1f}ms")
                with self._lock:
