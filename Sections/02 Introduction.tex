...
The purpose of this paper is to document the development, measurment and evalutaion of a video signal for Remote Train Operation, RTO. As progression for future railway develops, RTO, ATO is to be expected [kilde?]. And a important aspect for the scientific development is to have complete control over the tools beeing used. One of the tools necessary to achieve a higher Grade of Automatio, GOA, is 

development
It is crucial that the development and measurments needs to be replicable to determine if the results are thrustworthy.
...
Over the last development cycle, Voysys has been used. Voysys is an external developer specialising in video transmission for remote control. Using Voysys has been effective and with good end results. Yet, this thesis on developing a replacement was found needed. To do even more specialised developement for Train video transmission, full liberty to testing and development was needed. If the developement would reach a point where the latency was under acceptable thresholds, and change was not possible due to developement restrictions, it could have critical consequences. 
