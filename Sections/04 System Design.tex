...
IP Cameras:
Logged in with SADE, iVMS and Hikvision, to be set to standard IP address of 192.168.1.100, 101 and 102. This will remain IP address until manually overwritten.
...
With buffer:     waits\dots then |--||--||--||--||--|   (smooth, even)
...
avdec-h264: Software decodes H.264 to raw frames (this is the expensive step)
