...
\subsubsection{Adaptation to stable latency.}
Jernberg(2024) 
...
Table \ref{tab:LatencyMeasured} contains the papers inclduing own latency measurments of real test of remote control operation. Which method they use to measure, the threshold they decided to compare it to and where that threshold has its origin.
...
\textit{Maybe include calculations of speed of train, compare to the previous and discuss a posible latency treshhold. End in that research on spesificly train drivers on railway should be tested.
