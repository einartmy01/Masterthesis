\begin{table}[H]
    \centering
    \caption{BRISQUE visual quality statistics for codec configuration experiment tests (lower score = better quality)}\label{tab:quality_codec}
    ...
    \hline
    C2 & H.264 No Transcode & 29.90 & 12.19 & 49.83 & 38.59\\
    \hline
    ...
    \hline
    C6 & H.265 No Transcode & 17.64 & 0.45 & 69.12 & 36.94\\
    \hline
