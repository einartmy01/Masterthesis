\begin{table}[H]
    ...
    \end{tabular}
    \vspace{2pt}
    {\footnotesize * Transit latency for C4 is substituted with the measured transit latency of C8, which had the nearest matching throughput (26.187 vs.\ 26.267~Mbps).}
\end{table}
