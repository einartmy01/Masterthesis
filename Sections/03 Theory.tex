...
\begin{figure}[h]
    ...
    \begin{minipage}{0.35\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/SpatialRed.png}
        \caption{Spatial redundancy~\cite{kondoz2010}.}\label{fig:spatial-redundancy}
    \end{minipage}
    \hfill
    \begin{minipage}{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/TemperoalRed.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/264265HEVC.png}
    \caption{Difference between HEVC, H.265 technology, and H.264 of methdod for encoding~\cite{blomqvist2018}.}\label{fig:264v265encoding}
\end{figure}
