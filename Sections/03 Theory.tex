...
Beyond individual video quality, remote train driving typically requires multiple simultaneous camera views. A camera facing straight forward is needed for obstacle and signal detection, while side cameras support the operators experience, needed for immersivenes of speed and movement like you can see a Figure~\ref{fig:trippelmonitor}~\cite{fp2r2dato2023d5_4, jurgensen2025, neumeier2019}.
 
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Images/ThreeMonitorSetup.png}
    \caption{Three-screen teleoperation simulator setup used by Neumeier et al.\ to evaluate the effect of latency on remote driving performance~\cite{neumeier2019}.}\label{fig:trippelmonitor}
\end{figure}
% ─────────────────────────────────────────────────────────────────────────────
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{Images/264265HEVC.png}
    \caption{~\cite{blomqvist2018}.}\label{fig:264v265encoding}
\end{figure}
